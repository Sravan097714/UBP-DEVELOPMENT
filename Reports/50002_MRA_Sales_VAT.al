report 50002 "MRA Sales VAT"
{
    Caption = 'RC-MRA Sales VAT';
    ProcessingOnly = true;
                ...
                begin
                    ...
                    IF VatEntryRecordCount = Recordcount THEN BEGIN
                        IF Customer.Name <> ' ' THEN BEGIN
                            ...
                            ExcelBuf.AddColumn(Customer."Telex No.", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
    ...
    begin
        ...
        ExcelBuf.NewRow;
        //ExcelBuf.AddColumn("Company Information"."VAT Payer Tax", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);  //Need to add in table
        ExcelBuf.AddColumn("Company Information"."Giro No.", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);

report 50069 "Check alone"
{
    // //>>TBS82-ELL-26/06/17 : Modification mise en page
    // //>>TBS01-LIF-08/08/17 : prise en compte du champ "payee name"
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\Checkalone.rdl';
                    ...
                    CASE BalancingType OF
                        BalancingType::"G/L Account":
                            BEGIN
                                ...
                                CheckToAddr[1] := GenJnlLine."Payee Name";
                            END;
                        BalancingType::Customer:
                            BEGIN

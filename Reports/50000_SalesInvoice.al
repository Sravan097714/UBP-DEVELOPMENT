report 50000 "Standard Sales - Invoice1"
{
    RDLCLayout = 'Reports\Layout\Sales Invoice.rdl';
    WordLayout = 'Reports\Layout\Sales Invoice.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(TransportMethod; TransportMethDesc)
            {
            ...
            column(OrderNo_Lbl; 'Contract No.')
            {
            }
            ...
            column(Customer_BRN; Customer."Telex No.")
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(Quantity_Group; Quantity)
                {
                }
                ...
                column(Line_Discount_Amount; LineDiscountAmount)
                {
                }
                ...
                begin
                    ...
                    TransportMethDesc := '';
                    if TransportMethodRec.Get(Header."Transport Method") then
                        TransportMethDesc := TransportMethodRec.Description;
                    ...
                    SalesInvoiceLine.SetRange("Corresponding Item Line No", "Order Line No.");
                    if SalesInvoiceLine.FindSet() then begin
                        SalesInvoiceLine.CalcSums("Unit Price");
                        SalesInvoiceLine.CalcSums("Line Amount");
                        SumOfUnitPrice := format(SalesInvoiceLine."Unit Price" + "Unit Price");
                        SumofLineAmount := format(SalesInvoiceLine."Line Amount" + "Line Amount");
                        "Corresponding Item Line No" := "Order Line No.";
                    end else begin
                        if "Corresponding Item Line No" = 0 then
                            "Corresponding Item Line No" := "Line No." + 1;
                        SumOfUnitPrice := FormattedUnitPrice;
                        SumofLineAmount := FormattedLineAmount;
                    end;
                    ...
                    if Line."Line Discount Amount" = 0 then
                        LineDiscountAmount := ''
                    else
                        LineDiscountAmount := Format(Line."Line Discount Amount");
                end;
    ...
    var
        ...
        ShptMethodDescLbl: Label 'Vehicle No.';
        ...
        HeaderCaption: Label 'VAT Invoice';
        DiscountAmountLbl: Label 'Discount Amount';
    ...
    begin
        ...
        FillNameValueTable(LeftHeader, 'BRN No.', Customer."Telex No.");
        ...
        FillNameValueTable(LeftHeader, 'Contract No.', Header."Order No.");
        FillNameValueTable(LeftHeader, Header.FieldCaption("Document Date"), Format(Header."Document Date", 0, 4));
        /*FillNameValueTable(LeftHeader, Header.FieldCaption("Salesperson Code"), Header."Salesperson Code");
        ...
        FillNameValueTable(LeftHeader, Header.FieldCaption("Shipment Method Code"), Header."Shipment Method Code");
    ...
    begin
        ...
        FillNameValueTable(RightHeader, Header.FieldCaption("Shortcut Dimension 1 Code"), Header."Shortcut Dimension 1 Code");
        FillNameValueTable(RightHeader, Header.FieldCaption("Shortcut Dimension 2 Code"), Header."Shortcut Dimension 2 Code");
    end;
    ...
    begin
        ...
        with SalesInvoiceHeader do begin
            if "Currency Code" = '' then
                FormatDocument.SetTotalLabels(GenLedgersetup."LCY Code", TotalText, TotalInclVATText, TotalExclVATText)
            else

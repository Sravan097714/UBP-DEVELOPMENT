report 50003 "Input VAT copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\InputVATCopy.rdl';
    Caption = 'RC-Input VAT Report';
    ...
    dataset
    {
...

        {
            ...
            begin
                ...
                Clear(SupplierInvNo);
                Clear(SalesDesc);
                if PurInvHdr.Get("VAT Entry"."Document No.") then begin
                    DocDate := PurInvHdr."Document Date";
                    SupplierInvNo := PurInvHdr."Vendor Invoice No.";
                    SalesDesc := PurInvHdr."Posting Description";
                END else
                    if PurCrdHdr.Get("VAT Entry"."Document No.") then begin
                        DocDate := PurCrdHdr."Document Date";
                        SupplierInvNo := PurCrdHdr."Vendor Cr. Memo No.";

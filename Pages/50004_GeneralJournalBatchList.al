page 50004 "General Journal Batch Cust."
{
    //This Page has its filters based on user vs usersetup batch name - OnOpenPage so as to be used to show all batches //
    ...
    begin
        ...
        // if UserSetupRec."Batch Name" <> '' then
        //     NameLocal := UserSetupRec."Batch Name";

        // if NameLocal <> '' then
        //     SetFilter(Name, NameLocal);

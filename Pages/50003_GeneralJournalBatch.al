page 50003 "General Journal BatchDropdown"
{
    //This Page has its filters commented - OnOpenPage so as to be used to show all batches //
    Caption = 'General Journal Batches';
    DataCaptionExpression = DataCaption;
    CardPageId = "Cash Receipt Journal Cust.";
    PageType = List;
